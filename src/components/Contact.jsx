    ...
    <section id="contact" className="contact">
      <div className="container">
        ...
        <div className="contact-chips">
          <a href="mailto:cedricjoshua.palapuz@gmail.com" className="contact-chip">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
              <polyline points="22,6 12,13 2,6"></polyline>
            </svg>
            cedricjoshua.palapuz@gmail.com
          </a>
          <a href="tel:+639994051077" className="contact-chip">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div
          ...
          className={`contact-form-wrapper scroll-reveal fade-up ${isFormVisible ? 'visible' : ''}`}
        >
          <form
            ref={formRef}
